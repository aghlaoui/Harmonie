...
<div class="ec-vendor-card-body">
	<div class="row">
		...
		<div class="ec-vendor-upload-detail">
			<form class="row g-3 woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action('woocommerce_edit_account_form_tag'); ?>>
				...
				<div class="col-md-4 space-t-15">
					...
					<input style="margin-bottom: 0px;" type="text" class="woocommerce-Input woocommerce-Input--text input-text form-control" name="account_display_name" id="account_display_name" value="<?php echo esc_attr($user->display_name); ?>" />
					<span style="font-size: 12px;"><em><?php esc_html_e('This will be how your name will be displayed in the account section and in reviews', 'woocommerce'); ?></em></span>
				</div>
				<div class="clear"></div>
				...
				<div class="col-md-6 space-t-15">
					...
					<input type="password" style="margin-bottom: 0px;" class="woocommerce-Input woocommerce-Input--password input-text form-control" name="password_1" id="password_1" autocomplete="off" />
				</div>
				<div class="col-md-6 space-t-15">
				...
				<div class="col-md-12 space-t-15" style="margin-top: 15px;">
